...
Yes, there are these brilliant "magic" values in the code that just took some toying around for it to look nice for voice recordings 🧙‍♂️.

<LoopingAudioRecorderVisualizer />

Again this component is completely decoupled from the actual recording logic, this time however, it takes in quite a big set of different properties. It just allows for quicker experimentations

...
Many side-projects come and go, some stick around slightly longer, but most of them never outgrow there initial best intentions.

Making the repository public and calling that code dump "open-source" also doesn't feel like much value to anyone.

So, I'm trying something else: **"Open-Takeaways"**.

It contains code-fragments, ideas and demo's of the Tapes.me side-project with the intention to guide others that tackle similar challenges.

Jump to [the list of takeaways](#open-takeaways) if you want to skip the backstory.

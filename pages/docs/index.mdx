...
Just changing the repository to be public available and and calling that "open-source" also doesn't feel like much value to anyone. So, I'm trying something else:

**"Open-Takeaways"**: articles contiaining code-fragments, ideas and demo's with the intention to guide others that tackle similar challenges.

## The backstory of Tapes.me

<ReadMore moreText="Continue reading the backstory">
